...
def case1():
    ...
    return 'img01-before1.png', 'img01-after1.png'
def case2():
    # print("Using: tc300302_p000_s003_Satellite_Mode_Zoom_5km_DLS_STATE_4.png / tc300302_p000_s003_Satellite_Mode_Zoom_5km_DLS_STATE_4-after.png")
    return 'tc300302_p000_s003_Satellite_Mode_Zoom_5km_DLS_STATE_4.png', 'tc300302_p000_s003_Satellite_Mode_Zoom_5km_DLS_STATE_4-after.png'
...
NameOfImageBefore, NameOfImageAfter = switch_case[2]()
# print(switch_case[2]())
